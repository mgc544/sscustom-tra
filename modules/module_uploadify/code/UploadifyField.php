...
abstract class UploadifyField extends FormField
{
	...
	public function FieldHolder() {
		...
		Requirements::javascript("modules/module_uploadify/javascript/swfobject.js");
		Requirements::javascript("modules/module_uploadify/javascript/uploadify.js");
		Requirements::javascript(THIRDPARTY_DIR."/jquery-metadata/jquery.metadata.js");
		Requirements::javascript(THIRDPARTY_DIR."/jquery-livequery/jquery.livequery.js");
		Requirements::javascript("modules/module_uploadify/javascript/uploadify_init.js");
		...
		if(!$this->getSetting('uploader')) {
			$this->setVar('uploader',Director::baseURL().'modules/module_uploadify/javascript/uploadify.swf');
		}
		if(!$this->getSetting('cancelImg')) {
			$this->setVar('cancelImg',Director::baseURL().'modules/module_uploadify/images/cancel.png');
		}
